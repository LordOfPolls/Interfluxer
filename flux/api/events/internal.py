...
???+ hint "Example Usage"
    ...
    from flux.api.events import ChannelCreate  # or any other event
    ...
    For more information, including other ways to listen to events, see [the events guide](/flux.py/Guides/10 Events).
...
from flux.api.events.base import BaseEvent, RawGatewayEvent
from flux.client.utils.attr_utils import docs

if typing.TYPE_CHECKING:
    from flux import Extension, BaseCommand, Listener
...
if TYPE_CHECKING:
    from flux.models.internal.context import (
        BaseContext,
    )
