...
if TYPE_CHECKING:
    from flux import Client, Snowflake_Type
...
class ConnectionState:
    ...
    def get_voice_state(self, guild_id: "Snowflake_Type") -> Optional["flux.ActiveVoiceState"]:
        """
    ...
    async def voice_connect(
        ...
        """
        voice_state = flux.ActiveVoiceState(
            client=self.client,
            guild_id=guild_id,
