...
from flux.client.const import Absent, DISCORD_EPOCH, MISSING
from flux.client.errors import NotFound, VoiceNotConnected, TooManyChanges
...
if TYPE_CHECKING:
    ...
    from flux import Client, Embed, BaseComponent, AllowedMentions, Sticker, Message
