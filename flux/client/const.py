"""
Constants used throughout flux.py.
...
Attributes:
    ...
    logger_name str: The name of flux.py's default logger. Invalid if a custom logger is passed to `Client` to replace the default logger.
    logger logging.Logger: The logger used throughout flux.py. If a custom logger is passed to `Client`, this obj is replaced with the new logger.
