...
class Console(Extension):
    ...
    Args:
        ...
        **kwargs: The locals to make available in the console, by default this includes `client`, `bot` and `flux`

    """

    def __init__(self, client: flux.Client, port: int = 501, console_port: int = 502, **kwargs) -> None:
