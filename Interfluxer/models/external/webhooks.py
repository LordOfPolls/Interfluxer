...
from Interfluxer.client.const import MISSING, Absent
from Interfluxer.client.errors import ForeignWebhookException, EmptyMessageException, NotFound
from Interfluxer.client.mixins.send import SendMixin
from Interfluxer.client.utils.serializer import to_image_data
from Interfluxer.models.external.message import process_message_payload
from Interfluxer.models.external.snowflake import to_snowflake, to_optional_snowflake
...
if TYPE_CHECKING:
    ...
    from Interfluxer.models.external.enums import MessageFlags
    from Interfluxer.models.external.snowflake import Snowflake_Type
    from Interfluxer.models.external.channel import TYPE_MESSAGEABLE_CHANNEL
    from Interfluxer.models.external.components import BaseComponent
    from Interfluxer.models.external.embed import Embed

    from Interfluxer.models.external.message import (
        AllowedMentions,
        Message,
        MessageReference,
    )
...
class Webhook(FluxerObject, SendMixin):
