...
from Interfluxer.models.external.enums import TeamMembershipState
...
if TYPE_CHECKING:
    ...
    from Interfluxer.models.external.snowflake import Snowflake_Type, SnowflakeObject
