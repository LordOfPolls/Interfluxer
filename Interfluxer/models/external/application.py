...
from Interfluxer.models.external.enums import ApplicationFlags
...
from Interfluxer.models.external.team import Team
from .base import FluxerObject

if TYPE_CHECKING:
    from Interfluxer.client import Client
    from Interfluxer.models import User

__all__ = ("Application",)


@attrs.define(eq=False, order=False, hash=False, kw_only=True)
class Application(FluxerObject):
    ...
    """The hex encoded key for verification in Interfluxer and the GameSDK's GetTicket"""
