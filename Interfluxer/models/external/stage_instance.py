...
from Interfluxer.models.external.enums import StagePrivacyLevel
from Interfluxer.models.external.snowflake import to_snowflake
from .base import FluxerObject

if TYPE_CHECKING:
    from Interfluxer.models import Guild, GuildStageVoice, Snowflake_Type

__all__ = ("StageInstance",)


@attrs.define(eq=False, order=False, hash=False, kw_only=True)
class StageInstance(FluxerObject):
