...
from Interfluxer.client.const import MISSING
...
from Interfluxer.client.utils.attr_converters import optional
from Interfluxer.client.utils.attr_converters import timestamp_converter
from Interfluxer.models.external.emoji import PartialEmoji, process_emoji
...
if TYPE_CHECKING:
    ...
    from Interfluxer.models.external.user import User
    from Interfluxer.models.external.channel import TYPE_THREAD_CHANNEL
    from Interfluxer.models.external.snowflake import Snowflake_Type
    from Interfluxer import UPLOADABLE_TYPE, GuildForum
...
class ThreadMember(FluxerObject, SendMixin):
