...
from Interfluxer.client.const import MISSING, PREMIUM_GUILD_LIMITS, Absent
from Interfluxer.client.errors import EventLocationNotProvided, NotFound
from Interfluxer.client.mixins.serialization import DictSerializationMixin
from Interfluxer.client.utils.attr_converters import (
    list_converter,
    optional,
    timestamp_converter,
)
from Interfluxer.client.utils.attr_utils import docs
from Interfluxer.client.utils.serializer import no_export_meta, to_image_data
from Interfluxer.models.external.auto_mod import AutoModRule, BaseAction, BaseTrigger
from Interfluxer.models.external.file import UPLOADABLE_TYPE
from Interfluxer.models.external.onboarding import Onboarding
from Interfluxer.models.misc.iterator import AsyncIterator

from .base import ClientObject, FluxerObject
from .enums import (
    AuditLogEventType,
    AutoModEvent,
    AutoModTriggerType,
...
class Guild(BaseGuild):
    ...
    preferred_locale: str = attrs.field(repr=False, default=None)
...
class GuildIntegration(FluxerObject):
...
class GuildWidget(FluxerObject):
    name: str = attrs.field(repr=True)
...
@attrs.define(eq=False, order=False, hash=False, kw_only=True)
class AuditLogEntry(FluxerObject):
