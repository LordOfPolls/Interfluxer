...
from Interfluxer.client.const import MISSING, Absent, get_logger
from Interfluxer.client.mixins.serialization import DictSerializationMixin
from Interfluxer.client.utils import list_converter, optional
from Interfluxer.client.utils.attr_utils import docs
from Interfluxer.models.external.base import ClientObject, FluxerObject
...
from Interfluxer.models.external.snowflake import to_snowflake, to_snowflake_list
...
__all__ = ("TYPE_ALL_ACTION", "TYPE_ALL_TRIGGER", "AutoModRule", "AutoModerationAction")
...
class BlockMemberInteraction(BaseAction):
    """Block a member from using text, voice, or other Interfluxer"""

    # this action has no metadata


@attrs.define(eq=False, order=False, hash=False, kw_only=True)
class AutoModRule(FluxerObject):
