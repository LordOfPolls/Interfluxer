...
from Interfluxer.client.utils.attr_converters import optional as c_optional, list_converter
from Interfluxer.client.utils.attr_converters import timestamp_converter
from Interfluxer.client.utils.serializer import no_export_meta, export_converter
from Interfluxer.models.external.color import Color, process_color
from Interfluxer.models.external.enums import EmbedType
...
class Embed(DictSerializationMixin):
    ...
    """A list of [fields][Interfluxer.models.external.embed.EmbedField] to go in the embed"""
