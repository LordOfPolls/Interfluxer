...
from Interfluxer.client.const import Absent, MISSING
from Interfluxer.client.errors import HTTPException, TooManyChanges
from Interfluxer.client.mixins.send import SendMixin
from Interfluxer.client.utils.attr_converters import list_converter, optional
...
from Interfluxer.models.external.enums import Permissions, PremiumType, UserFlags, Status, MemberFlags
...
@attrs.define(eq=False, order=False, hash=False, kw_only=True)
class BaseUser(FluxerObject, _SendDMMixin):
...
@attrs.define(eq=False, order=False, hash=False, kw_only=True)
class Member(FluxerObject, _SendDMMixin):
    bot: bool = attrs.field(repr=True, default=False, metadata=docs("Is this user a bot?"))
