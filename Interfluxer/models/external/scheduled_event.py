...
from Interfluxer.client.errors import EventLocationNotProvided
from Interfluxer.client.utils import to_image_data
...
from Interfluxer.models.external.snowflake import Snowflake_Type, to_snowflake
...
if TYPE_CHECKING:
    ...
    from Interfluxer.models.external.channel import GuildStageVoice, GuildVoice
    from Interfluxer.models.external.guild import Guild
    from Interfluxer.models.external.user import Member
...
class ScheduledEvent(FluxerObject):
