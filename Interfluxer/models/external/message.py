...
from Interfluxer.client.const import GUILD_WELCOME_MESSAGES, MISSING, Absent
from Interfluxer.client.errors import NotFound, ThreadOutsideOfGuild
...
from Interfluxer.client.utils.text_utils import mentions
from Interfluxer.models.external.channel import BaseChannel, GuildChannel
from Interfluxer.models.external.embed import process_embeds
...
@attrs.define(eq=False, order=False, hash=False, kw_only=True)
class ChannelMention(FluxerObject):
...
@attrs.define(eq=False, order=False, hash=False, kw_only=True)
class BaseMessage(FluxerObject):
...
class Message(BaseMessage):
    ...
    """If the message is an application-owned webhook, this is the id of the application"""
