...
import Interfluxer.models as models
from Interfluxer.client.const import Absent, FLUXER_EPOCH, MISSING
from Interfluxer.client.errors import NotFound, VoiceNotConnected, TooManyChanges
from Interfluxer.client.mixins.send import SendMixin
from Interfluxer.client.mixins.serialization import DictSerializationMixin
from Interfluxer.client.utils.attr_converters import optional as optional_c
from Interfluxer.client.utils.attr_converters import timestamp_converter
from Interfluxer.client.utils.misc_utils import get
from Interfluxer.client.utils.serializer import to_dict, to_image_data
from Interfluxer.models.external.base import FluxerObject
from Interfluxer.models.external.emoji import PartialEmoji
from Interfluxer.models.external.file import UPLOADABLE_TYPE
from Interfluxer.models.external.snowflake import (
    Snowflake_Type,
    to_snowflake,
    to_optional_snowflake,
    SnowflakeObject,
)
from Interfluxer.models.external.thread import DefaultReaction, ThreadTag
from Interfluxer.models.misc.context_manager import Typing
from Interfluxer.models.misc.iterator import AsyncIterator
from .enums import (
    ChannelFlags,
    ChannelType,
    OverwriteType,
...
if TYPE_CHECKING:
    ...
    from Interfluxer import Client, Embed, BaseComponent, AllowedMentions, Sticker, Message
...
class MessageableMixin(SendMixin):
    ...
    async def purge(
        ...
        fourteen_days_ago = int((time.time() - 1209600) * 1000.0 - FLUXER_EPOCH) << 22
...
@attrs.define(eq=False, order=False, hash=False, slots=False, kw_only=True)
class BaseChannel(FluxerObject):
