...
from Interfluxer.models.external.application import Application
from Interfluxer.models.external.enums import InviteTargetType
from Interfluxer.models.external.guild import GuildPreview
...
if TYPE_CHECKING:
    ...
    from Interfluxer.models import TYPE_GUILD_CHANNEL, Guild
