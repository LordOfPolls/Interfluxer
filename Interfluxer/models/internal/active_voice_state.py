...
from Interfluxer.api.voice.player import Player
from Interfluxer.api.voice.recorder import Recorder
from Interfluxer.api.voice.voice_gateway import VoiceGateway
from Interfluxer.client.const import MISSING, Missing
from Interfluxer.client.errors import VoiceAlreadyConnected, VoiceConnectionTimeout
from Interfluxer.client.utils import optional
...
if TYPE_CHECKING:
    from Interfluxer.api.voice.audio import BaseAudio
