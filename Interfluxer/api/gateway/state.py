...
from Interfluxer.client.errors import LibraryException, WebSocketClosed
from Interfluxer.models.external.activity import Activity
from Interfluxer.models.external.enums import Intents, Status, ActivityType
from .gateway import GatewayClient

if TYPE_CHECKING:
    from Interfluxer import Client, Snowflake_Type
...
class ConnectionState:
    ...
    def get_voice_state(self, guild_id: "Snowflake_Type") -> Optional["Interfluxer.ActiveVoiceState"]:
        """
    ...
    async def voice_connect(
        ...
        """
        voice_state = Interfluxer.ActiveVoiceState(
            client=self.client,
            guild_id=guild_id,
