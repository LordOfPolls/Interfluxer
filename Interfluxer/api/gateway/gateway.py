"""Outlines the interaction between Interfluxer and Discord's Gateway API."""
...
from Interfluxer.api import events
from Interfluxer.client.const import MISSING, __api_version__
from Interfluxer.client.utils.input_utils import FastJson
from Interfluxer.client.utils.serializer import dict_filter_none
from Interfluxer.models.external.enums import Status
from Interfluxer.models.external.enums import WebSocketOPCode as OPCODE
from Interfluxer.models.external.snowflake import to_snowflake
from Interfluxer.models.internal.cooldowns import CooldownSystem
        ...
        match event:
            case "READY":
                ...
                if resume_url := data.get("resume_gateway_url"):
                    self.ws_resume_url = f"{resume_url}?encoding=json&v={__api_version__}&compress=zlib-stream"
                else:
