...
import Interfluxer.models
from Interfluxer.api.events.base import BaseEvent, GuildEvent
from Interfluxer.client.const import Absent
from Interfluxer.client.utils.attr_utils import docs
from Interfluxer.models.external.snowflake import to_snowflake
...
if TYPE_CHECKING:
    ...
    from Interfluxer.models.external.auto_mod import AutoModerationAction, AutoModRule
    from Interfluxer.models.external.channel import (
        TYPE_ALL_CHANNEL,
        TYPE_THREAD_CHANNEL,
        VoiceChannel,
    )
    from Interfluxer.models.external.emoji import CustomEmoji, PartialEmoji
    from Interfluxer.models.external.entitlement import Entitlement
    from Interfluxer.models.external.guild import Guild, GuildIntegration
    from Interfluxer.models.external.message import Message
    from Interfluxer.models.external.poll import Poll
    from Interfluxer.models.external.reaction import Reaction
    from Interfluxer.models.external.role import Role
    from Interfluxer.models.external.scheduled_event import ScheduledEvent
    from Interfluxer.models.external.snowflake import Snowflake_Type
    from Interfluxer.models.external.stage_instance import StageInstance
    from Interfluxer.models.external.sticker import Sticker
    from Interfluxer.models.external.timestamp import Timestamp
    from Interfluxer.models.external.user import BaseUser, Member, User
...
class InviteCreate(BaseEvent):
    ...
    invite: Interfluxer.models.Invite = attrs.field(
        repr=False,
    )
...
class GuildAuditLogEntryCreate(GuildEvent):
    ...
    audit_log_entry: Interfluxer.models.AuditLogEntry = attrs.field(repr=False)
